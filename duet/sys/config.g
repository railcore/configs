...
M98 P"zprobes/probe-ir.g"                       ; Run IR Probe configuration file.
;M98 P"zprobes/probe-switch.g"                  ; Run Switch Probe configuration file. (untested/community submitted)
;M98 P"zprobes/probe-bltouch.g"                 ; Run BLTouch configuration file.
;M98 P"zprobes/probe-orion.g"                   ; Run Piezo Orion configuration file (untested/community submitted)
